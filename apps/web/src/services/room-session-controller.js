...
window.sidevoiceActions={
 ...
 updateLanguageModel(language,model){
  voiceDraft[language]={...voiceDraft[language],model,voice:'inherit'};renderLanguageRows();
 },
