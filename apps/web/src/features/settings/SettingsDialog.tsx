...
function AdvancedSettings() {
  return (
    <section id="pane-advanced" aria-labelledby="settings-advanced" hidden>
      ...
      <label>Volumen del sonido de presencia <output id="presence-volume-value">7 %</output><input id="presence-volume" type="range" min="1" max="20" step="0.5" defaultValue="7" /></label>
