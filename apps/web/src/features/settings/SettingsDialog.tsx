...
function AdvancedSettings() {
  return (
    <section id="pane-advanced" aria-labelledby="settings-advanced" hidden>
      ...
      <label>Sonido de presencia<NativeSelect id="presence-sound" defaultValue="off"><option value="on">Activado</option><option value="off">Desactivado</option></NativeSelect></label>
      <label>Volumen del sonido de presencia <output id="presence-volume-value">3,5 %</output><input id="presence-volume" type="range" min="1" max="12" step="0.5" defaultValue="3.5" /></label>
      ...
      <label>Voz mínima para abrir una intervención (segundos)<input id="vad-start-secs" type="number" min="0.05" max="1" step="0.05" defaultValue="0.2" /></label><p className="muted">Cuánta voz seguida hace falta para que empiece tu turno e interrumpa una respuesta. Súbelo si la voz de la sala por el altavoz te corta las respuestas; el audio anterior a ese umbral se conserva. Por defecto: 0,2.</p>
