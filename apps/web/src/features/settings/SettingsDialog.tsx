...
function AdvancedSettings() {
  return (
    <section id="pane-advanced" aria-labelledby="settings-advanced" hidden>
      ...
      <label className="checkbox"><input id="mic-pause-during-playback" type="checkbox" /> Silenciar el micrófono mientras suena la respuesta</label><p className="muted">Para altavoces y móviles en los que la voz de la sala vuelve a entrar por el micrófono. Con esto activado no puedes interrumpir hablando: usa el botón de parar.</p>
